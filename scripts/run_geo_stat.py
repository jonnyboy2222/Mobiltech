...
def main():
    ...
    parser.add_argument("--config", type=str, default="configs/geo_stat.yaml")
    ...
    parser.add_argument("--min_var", type=float, default=None)
    ...
    eps = args.eps if args.eps is not None else cfg["method"]["eps"]
    ...
    min_var = args.min_var if args.min_var is not None else cfg["method"]["min_var"]
